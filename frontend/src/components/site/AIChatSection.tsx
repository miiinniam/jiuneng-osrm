      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        ...
        <div className="lg:hidden">
          ...
          <button
            ...
            className="mt-7 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[var(--blue)] px-5 py-3.5 text-sm font-semibold text-white shadow-lg shadow-[#0040c0]/25 transition-all active:scale-[0.98]"
          >
